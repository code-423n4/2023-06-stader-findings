1.The `createLot` method of the `Auction` contract does not check whether the value of `_sdAmount` is equal to 0, because an auction with a quantity of 0 is meaningless
